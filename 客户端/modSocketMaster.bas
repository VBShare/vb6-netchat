...
Const MOD_USER As String = "user32"                         'Location of the SetWindowLong & CallWindowProc functions
  ...
  nLen = GetLong(sHex)                                          'Length of hex pair string
...
Public Function GetLong(ByVal sString)
    GetLong = 0
...
Public Function GetLeft(ByVal sString, ByVal lLength)
